...
export const AboutUs = () => {
  return (
    ...
    <div class="bg-white w-full h-full">
        ...
        <div class="grid gap-8 pb-10 md:grid-cols-1 w-1/2 mx-auto ">
          ...
          <div class="items-center  rounded-lg shadow sm:flex bg-gray-100 ">
              <a href="#">
                  <img class="w-[300px] rounded-lg sm:rounded-none sm:rounded-l-lg" src={team1} alt="Bonnie Avatar"/>
              </a>
              <div class="p-5">
          ...
          <div class="items-center  rounded-lg shadow sm:flex bg-gray-100">
              <a href="#">
                  <img class="w-[300px] rounded-lg sm:rounded-none sm:rounded-l-lg" src={team2} alt="Jese Avatar"/>
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight">
                      <a href="#">Charles</a>
          ...
          <div class="items-center  rounded-lg shadow sm:flex bg-gray-100">
              <a href="#">
                  <img class="w-[300px]rounded-lg sm:rounded-none sm:rounded-l-lg" src={team3} alt="Michael Avatar"/>
              </a>
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight">
                      <a href="#">Ralph</a>
