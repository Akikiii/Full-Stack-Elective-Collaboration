...
import BG380 from '../assets/accessories/magazines/magazine 3.jpg'
            ...
            <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                <div className="border-b border-gray-200 pb-6">
                    ...
                    <h1
						...
						"
                    >
                        MAGAZINE FOR 5.56 NATO/ .223 CAL. 30 RNDS. FLAT DARK EARTH MAGAZINE
                    </h1>
                </div>
                ...
                <div>
                    ...
                    <p className="text-base leading-4 mt-4 text-gray-600"><span className="font-bold">SKU:</span> 000708</p>
