...
import KNIVES from '../assets/accessories/knives/baton2.jpg'
        ...
        <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
            ...
            <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                ...
                <div className="py-4 border-b border-gray-200 flex items-center justify-between">
                    <p className="text-xl leading-4 text-black text-bold">₱3,600.00</p>
                </div>
                <div>
                    <p className="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 mt-7">CLOSED LENGTH: 6.3”</p>
