...
import BG380 from '../assets/guns/shotguns/590a1 ghost ring.jpg'
            ...
            <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                <div className="border-b border-gray-200 pb-6">
                    ...
                    <h1
						...
						"
                    >
                        590A1 TACTICAL GHOST RING SIGHTS
                    </h1>
                </div>
                <div className="py-4 border-b border-gray-200 flex items-center justify-between">
                    <p className="text-xl leading-4 text-black text-bold">₱72,500.00</p>
                </div>
                <div>
                    ...
                    <p className="text-base leading-4 mt-4 text-gray-600"><span className="font-bold">SKU:</span> 000701</p>
